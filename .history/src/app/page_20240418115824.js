    ...
    <section className="statistical-section">
      ...
      <div className="statistical-content-two">
        ...
        <div className="statistical-content-two-wrapper">
          {/* <Image src="/img/dashbroad/db_img_2.svg" width={558} height={297} /> */}
          <img
            src="/img/dashbroad/db_img_2.png"
            style={{ width: "558px", height: "297px" }}
          />

          <div>
            <h3>Chi tiết lịch đặt</h3>
            <Image src="/img/dashbroad/db_img_3.svg" width={444} height={254} />
          </div>
        </div>
      </div>
    </section>
